            ...
            <div class="box box-primary">
                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <form  id="editForm" action="${pageContext.request.contextPath}/basedata/ordres/findAll" method="post" >
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/basedata/ordres/show?id=${orders.id}'">
                                            详情
                                        </button>
                                    </td>
                                </tr>
                    ...
                    <div class="box-footer">
                        <jsp:include page="../../common/page.jsp">
                            <jsp:param value="${pageContext.request.contextPath}/basedata/ordres/findAll"
                                       name="pageUrl"/>
                        </jsp:include>
                    </div>
                </div>
    ...
    function deleteByIds() {
        ...
        if (ids) {
            if (confirm("你确认要删除此条记录吗？")) {
                location.href = "${pageContext.request.contextPath}/basedata/ordres/deleteByids?ids=" + ids;
            }
        } else {
