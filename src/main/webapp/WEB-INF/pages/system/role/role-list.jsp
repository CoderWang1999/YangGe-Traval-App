    ...
    function deleteByIds() {
        ...
        if (ids) {
            if (confirm("你确认要删除这些记录吗？")) {
                location.href = "${pageContext.request.contextPath}/servlet/role/delete?ids=" + ids;
            }
        } else {
            alert("请勾选待处理的记录，且每次至少勾选一个")
        }
    }
            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                        ...
                        <div class="pull-left">
                            <div class="form-group form-inline">
                                <div class="btn-group">                                                                                                        <%-- /pages/role-add.jsp --%>
                                    <button type="button" class="btn btn-default" title="新建"
                                            onclick="location.href='${pageContext.request.contextPath}/servlet/role/list'">
                        ...
                        <table id="dataList"
                            ...
                            <%--<tr>
                                ...
                                <td class="text-center">
                                    <a href="/servlet/role/list?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
                                    <a href="${pageContext.request.contextPath}/pages/role-permission-add.jsp" class="btn bg-olive btn-xs">更改权限资源</a>
                                </td>
                            </tr>--%>
                            <c:forEach items="${page.list}" var="role">
                                <tr>                                       <%-- 这里需要加value--%>
                                    ...
                                    <td>${role.roleDesc }</td>
                                    <td class="text-center">
                                        <a href="/servlet/role/toEdit?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
                                        <a href="${pageContext.request.contextPath}/servlet/role/findRoleAndPermission?roleId=${role.id}"
                ...
                <div class="box-footer">
                    <jsp:include page="/WEB-INF/pages/common/page.jsp">
                        <jsp:param value="${pageContext.request.contextPath}/servlet/role/findAll"
                                   name="pageUrl"/>
                    </jsp:include>
                </div>
            </div>
