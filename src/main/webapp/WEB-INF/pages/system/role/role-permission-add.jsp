...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<form id="editForm"
		<%--action="${pageContext.request.contextPath}/servlet/role/"--%>
			  method="post">
			<!-- 正文区域 -->
			<section class="content">
					...
					<c:forEach items="${permissionList}" var="permission">
						<tr>
							<td>
								...
								<input name="ids" id="ids"  type="checkbox" ${permission.flag==1?'checked':''} value="${permission.id}">
				...
				<div class="box-tools text-center">
					<button type="button" class="btn bg-maroon" onclick="updateById();">保存</button>
...
<script>
	function updateById() {
		...
		if(id.length>0) {
			if(confirm("你确认要修改吗？")) {
				location.href="${pageContext.request.contextPath}/servlet/role/updateRolePermission?ids="+id+"&roleId=${role.id}";
			}
		}
	}
